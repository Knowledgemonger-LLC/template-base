...
1. Read `DOMAIN_MODEL.md`, `GLOSSARY.md`, and any product or requirements docs bearing on the
   question. Say which you read.
...
5. Flag every gap you hit — a term with no `GLOSSARY.md` entry, an entity the product docs imply
   but the domain model lacks, a question the inputs cannot settle. These are the output, not noise:
